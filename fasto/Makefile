...
$(DeadBindingRemovalLib): src/DeadBindingRemoval.fs $(AbSynLib) $(CallGraphLib) $(SymTabLib)
	$(fsharpc) -a src/DeadBindingRemoval.fs -r $(AbSynLib) -r $(CallGraphLib) -r $(SymTabLib) -o $(DeadBindingRemovalLib)
